...
import wisoft.entertainment.*;
import wisoft.entertainment.MyBatisEntertainmentService;

import java.util.List;

public class AppInitEntertainmentMyBatis {
    public static void main(String[] args) {
        final MyBatisEntertainmentService entertainmentService = new MyBatisEntertainmentService();
...
//        System.out.println(departmentResults);
...
//            employeeResults = entertainmentService.getEmployees();
...
//                 employeeResults.forEach(employee -> {
//                 System.out.println("[연예관계자 이름] " + employee.getEmpRname() + " || [Avg] " + employee.getSalAvg() + " || [Min] "
...
//             employeeResults = entertainmentService.getEmployeeSal3();
//             employeeResults.forEach(employee -> {
//                 System.out.println("[연예관계자 이름] " + employee.getEmpName() + " || [급여] " + employee.getEmpSal());
//             });
//             System.out.println();
